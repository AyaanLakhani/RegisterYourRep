...
export default function Dashboard() {
  const { user, logout, getAccessToken, authenticated, ready } = usePrivy()
  ...
  useEffect(() => {
    ...
    getAccessToken()
      .then(token => fetch('/api/auth/privy', {
        method: 'POST', credentials: 'include',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ token }),
      }))
      .catch(() => {})
  }, [ready, authenticated]) // eslint-disable-line
  ...
  useEffect(() => {
    ...
    if (!ready || !authenticated) return <div className="loading">Loading...</div>
                ...
                <div className={styles.overviewSidebar}>
                  <div className={styles.sidebarCard}>
                    <div className={styles.sidebarHeader}>
                      ...
                      <button className={styles.sidebarLink} onClick={() => router.push('/workcards')}>View all →</button>
                    </div>
